...
class ForecastData(Base):
    ...
    sessions_lower_85 = Column(Integer, nullable=False)
    sessions_upper_85 = Column(Integer, nullable=False)
    sessions_lower_95 = Column(Integer, nullable=False)
    sessions_upper_95 = Column(Integer, nullable=False)
    ...
    def update(row):
        session.query(ForecastData).\
            ...
            ForecastData.date == row['date'],ForecastData.medium == row['medium'])).\
        session.commit()
